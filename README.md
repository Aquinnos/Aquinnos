...
I am a Fullstack Developer building fast, modern, and scalable web applications. I handle the entire development process from design to deployment. My primary stack is Next.js, React, and TypeScript on the frontend, combined with Node.js, Express, and MongoDB on the backend.
...
- **Next.js, React, TypeScript, Tailwind CSS** - Performance optimization & responsive UI design  
...
- **Developing Back-End Apps with Node.js and Express** (IBM / Coursera) - [Verify Certificate](https://coursera.org/verify/CM179RUV1WSV)

#### **🛠 DevOps & Tools**
- **Git, GitHub, Docker, Docker Compose** - Deployment on **Vercel, Render** ---
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ksynakowski403/)
